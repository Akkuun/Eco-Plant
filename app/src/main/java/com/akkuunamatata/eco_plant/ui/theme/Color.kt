...
object Support {
    object Sucess {
        val SuccessHigh = Color(0xFF298267)
        val SuccessMedium = Color(0xFF3AC0A0)
        val SuccessMediumLow = Color(0xFFE7F4E8)
    }
    object Warning {
        val WarningHigh = Color(0xFFE86339)
        val WarningMedium = Color(0xFFFFB37C)
        val WarningMediumLow = Color(0xFFFFF4E4)
    }
    object Error {
        val ErrorHigh = Color(0xFFED3241)
        val ErrorMedium = Color(0xFFFF616D)
        val ErrorMediumLow = Color(0xFFFFE2E5)
    }
}